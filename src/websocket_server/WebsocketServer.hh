  ...
  namespace test
  {
    ...
    class WebsocketServer
    {
      public: class Config
      {
        ...
        public: double publicationHz{60.0};
        public: std::string authorizationKey{""};
        public: std::string adminAuthorizationKey{""};
        public: std::string sslCertFile;
        public: std::string sslPrivateKeyFile;
      };
      ...
      public: virtual bool Load(const WebsocketServer::Config &_config);
